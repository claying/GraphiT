...
def main():
    ...
    train_dset = GraphDataset(dataset[split_idx['train']], n_tags, degree=True)
    ...
    val_dset = GraphDataset(dataset[split_idx['valid']], n_tags, degree=True)
    ...
    test_dset = GraphDataset(dataset[split_idx['test']], n_tags, degree=True)
